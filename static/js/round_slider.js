class RoundSlider {
     ...
     * @param {array} sliders
     */
    constructor({ DOMselector, barChart, sliders }) {
        this.DOMselector = DOMselector;
        this.barChart = barChart;                                   // Associated a Chart.js bar chart
        this.container = document.querySelector(this.DOMselector);  // Slider container
        this.sliderWidth = 250;                                     // Slider width
        this.sliderHeight = 250;                                    // Slider length
    ...
    updateLegendUI(currentAngle) {
        ...
        this.updateBarChart(currentValue);
    }

    // Update the data in bar chart.
    updateBarChart(value) {
        this.barChart.manualValue = value; 
    }
